...
(function ($) {
  $(document).ready(function () {
    ...
    const skillTags = [
      'Figma', 'Photoshop', 'Adobe XD', 'Zepplin',
      'Kanban', 'Linear', 'Azure', 'Jira',
      'Github', 'GitLab', 'Heroku', 'Vercel', 'Netlify',
      'Docker', 'Cypress', 'Jest', 'Enzyme', 'Restful API', 'GraphQL',
      'Rechart', 'Highchart', 'react-chartjs-2', 'Solidity',
      'MongoDB', 'MySQL', 'PostgreSQL', 'Prismic',
      'Strapi', 'Contentful', 'Sanity', 'Storyblok', 'Wordpress'
    ];
